...
Indonesian phrases also work: <i>"hari ini"</i>, <i>"minggu ini"</i>.
        ...
        if user_input:
            ...
            if sensor and direction and r_periods:
                ...
                if not periods:
                    reply   = ("I didn't recognise a time period or sensor/direction.\n\n"
                               "Try: **today**, **this week**, or **compare today and yesterday**.\n"
                               "For rankings: **highest temperature this week**, "
                               "**lowest humidity today**, **maximum pressure this month**.")
                    results = []
                else:
                    results = []
